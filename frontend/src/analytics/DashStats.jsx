...
const DashStats = ({ type = "main" }) => {
  return (
    <div
      className={`grid ${
        type === "mini" ? "grid-cols-1" : "md:grid-cols-2 lg:grid-cols-3"
      } flex bg-white`}
    >
      <div
        className={`col-span-1 border my-1 lg:my-0 md:mx-1 shadow rounded flex gap-3 p-4`}
      >
      ...
      >
        <div className='h-full py-4 flex flex-col justify-end items-center'>
          <img
            ...
            alt='chef'
            className='w-14 h-14 rounded-full img-cover border'
          />
          <p className='text-gray-600 text-sm'>5 Cooks</p>
        </div>
        <div className='flex flex-col items-center justify-center'>
          <div className='w-20 h-14 rounded flex items-center justify-center bg-slate-100'>
            <GroupAddOutlinedIcon
              className='text-amber-400'
              style={{ fontSize: "40px" }}
            />
          </div>
          <h6 className='text-gray-700 font-semibold'>15 Employees</h6>
        </div>
        <div className='h-full py-4 flex flex-col justify-end items-center'>
          <img
          ...
          />
          <p className='text-gray-600 text-sm'>10 Waiters</p>
        </div>
      </div>
      <div
        className={`col-span-1border my-1 lg:my-0 md:mx-1 shadow rounded flex gap-3 p-4`}
      >
        <div className='w-20 h-20 rounded flex items-center justify-center bg-slate-100 text-3xl'>
          <PaidOutlinedIcon
            className='text-amber-400'
