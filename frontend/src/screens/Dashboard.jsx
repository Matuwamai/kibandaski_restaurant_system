  ...
  return (
    <div className=''>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 bg-white'>
        <div className='col-span-1 border my-1 lg:my-0 md:mx-1 shadow rounded flex gap-3 p-4'>
        ...
        <div className='col-span-1 md:col-span-2 lg:col-span-1 border my-1 lg:my-0 md:mx-1 shadow rounded flex gap-3 p-4'>
          <div className='w-20 h-20 rounded flex items-center justify-center bg-slate-100 text-3xl'>
            <PaidOutlinedIcon
              className='text-amber-400'
              style={{ fontSize: "40px" }}
